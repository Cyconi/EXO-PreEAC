...
namespace WButton.Api
{
    public class VRCList
    {
        public VRCList(Transform parent,string name,int Position = 0)
        {
            ...
            //GameObject.GetComponent<UiAvatarList>().field_Public_PageAvatar_0 = UiAvatarList.NativeFieldInfoPtr_field_Public_UiAvatarList_0.SpecificList;

...
using MelonLoader;
using xButtonAPI.Controls.Base_Classes;
...
namespace xButtonAPI.Controls
{
    ...
    {
        public ToggleButton(Transform parent, string text, string tooltipWhileDisabled, string tooltipWhileEnabled, Action<bool> stateChanged, Sprite OnImage = null, Sprite OffImage = null, bool DefaultState = false, bool BGImage = false)
        {
            gameObject = Object.Instantiate(xButtonAPI.toggleButtonBase, parent);
            ...
            {
                this.OnImage.sprite = xButtonAPI.onIconSprite;
                this.OnImage.overrideSprite = xButtonAPI.onIconSprite;
            }

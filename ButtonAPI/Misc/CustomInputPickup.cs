...
using MelonLoader;
using xButtonAPI.External_Libraries;
using TMPro;
using UnityEngine;
    ...
    public class CustomInputPickup
    {
        ...
        internal class FreezeControlsTMP : MonoBehaviour
        {
            ...
            void Start()
            {
                ...
                qm = xButtonAPI.GetQuickMenuInstance();
            }
        ...
        {
            if (new IL2CPPAssetBundle() is var Bundle && Bundle.LoadBundle(Assembly.GetExecutingAssembly(), "xButtonAPI.Resources.keyboard.asset"))
            {
